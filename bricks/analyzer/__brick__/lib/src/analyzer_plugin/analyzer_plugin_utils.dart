...
import 'package:{{analyzer_name.snakeCase()}}/src/utils/path_utils.dart';

abstract class AnalyzerPluginUtils {
  static const _severityMapping = {
  ...
  static plugin.AnalysisErrorFixes codeIssueToAnalysisErrorFixes(
    Issue issue,
    ResolvedUnitResult? unitResult,
  ) {
    final fileWithIssue = PathUtils.uriToPath(issue.location.sourceUrl) ?? '';
