...
import 'package:{{analyzer_name.snakeCase()}}/src/analyzer_plugin/analyzer_plugin_utils.dart';
import 'package:{{analyzer_name.snakeCase()}}/src/analyzers/lint_analyzer/lint_analysis_config.dart';
import 'package:{{analyzer_name.snakeCase()}}/src/analyzers/lint_analyzer/lint_analysis_options_validator.dart';
import 'package:{{analyzer_name.snakeCase()}}/src/analyzers/lint_analyzer/lint_analyzer.dart';
import 'package:{{analyzer_name.snakeCase()}}/src/config_builder/config_builder.dart';
import 'package:{{analyzer_name.snakeCase()}}/src/config_builder/models/analysis_options.dart';
import 'package:{{analyzer_name.snakeCase()}}/src/version.dart';
...
class AnalyzerPlugin extends ServerPlugin {
  ...
  @override
  String get contactInfo => '<your-contact-web>';

  @override
  List<String> get fileGlobsToAnalyze => const ['*.dart', '*.yaml'];

  @override
  String get name => '{{analyzer_name.titleCase()}} $packageVersion';
