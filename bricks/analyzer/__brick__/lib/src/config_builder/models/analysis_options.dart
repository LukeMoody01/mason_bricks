...
import 'package:{{analyzer_name.snakeCase()}}/src/utils/yaml_utils.dart';
import 'package:yaml/yaml.dart';

/// Class representing dart analysis options.
class AnalysisOptions {
  final Map<String, Object> options;
  static const _analysisOptionsFileName = 'analysis_options.yaml';
  static const _rootKey = '{{analyzer_name.snakeCase()}}';
  final String? _path;
        ...
        Map<String, Map<String, Object>>.fromEntries(
          data.fold([], (previousValue, element) {
            ...
            if (element is Map<String, Object>) {
              ...
              if (hasSingleKey && value is Map<String, Object> ||
                  value is bool) {
  ...
  static AnalysisOptions? analysisOptionsFromContext(
  ...
  static AnalysisOptions analysisOptionsFromFilePath(
    String path,
    AnalysisContext context,
  ) {
    final analysisOptionsFile =
        File(p.absolute(path, _analysisOptionsFileName));

    return analysisOptionsFromFile(analysisOptionsFile, context);
  }

  static AnalysisOptions analysisOptionsFromFile(
    File? options,
    AnalysisContext context,
  ) =>
  ...
  static Map<String, Object> _loadConfigFromYamlFile(
    File options,
  ...
  static Map<String, Object> _resolveImportAsOptions(
    File options,
    UriConverter converter,
    String path,
