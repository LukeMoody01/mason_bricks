  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= {{#pascalCase}}{{project_name}}{{/pascalCase}}Breakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= {{#pascalCase}}{{project_name}}{{/pascalCase}}Breakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= {{#pascalCase}}{{project_name}}{{/pascalCase}}Breakpoints.large) {
